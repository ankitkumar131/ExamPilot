...
(function () {
  ...
  const demoSettings = {
    providers: {
      openai: { enabled: true, apiKeys: ['••••sk1'], model: 'gpt-4o-mini', baseUrl: 'https://api.openai.com/v1', hasKey: true },
      anthropic: { enabled: true, apiKeys: ['••••sk2'], model: 'claude-sonnet-4-5', baseUrl: 'https://api.anthropic.com', hasKey: true },
      gemini: { enabled: true, apiKeys: ['••••sk3'], model: 'gemini-2.5-flash', baseUrl: 'https://generativelanguage.googleapis.com', hasKey: true },
      groq: { enabled: true, apiKeys: ['••••sk4a', '••••sk4b'], model: 'llama-3.3-70b-versatile', baseUrl: 'https://api.groq.com/openai/v1', hasKey: true },
      mistral: { enabled: false, apiKeys: [], model: 'mistral-large-latest', baseUrl: 'https://api.mistral.ai/v1' },
      deepseek: { enabled: false, apiKeys: [], model: 'deepseek-chat', baseUrl: 'https://api.deepseek.com/v1' },
      together: { enabled: false, apiKeys: [], model: 'meta-llama/Meta-Llama-3.1-70B-Instruct-Turbo', baseUrl: 'https://api.together.xyz/v1' },
      openrouter: { enabled: false, apiKeys: [], model: 'openai/gpt-4o-mini', baseUrl: 'https://openrouter.ai/api/v1' },
      azure: { enabled: false, apiKeys: [], model: '', baseUrl: '', resource: '', deployment: '', apiVersion: '2024-08-01-preview' },
      ollama: { enabled: false, apiKeys: [], model: 'llama3.1:8b', baseUrl: 'http://localhost:11434/v1' },
      custom: { enabled: false, apiKeys: [], model: '', baseUrl: 'http://localhost:1234/v1' },
    },
